<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link <?php if(!isset($_GET['login']) && !isset($_GET['signup']) && !isset($_GET['ask']) && !isset($_GET['myQues']) && !isset($_GET['latest'])){echo 'active';} ?>" href="./">Home</a>
        </li>
        <?php session_start() ?>
        ...
        <?php endif ?>
        <li class="nav-item">
          <a class="nav-link <?php if(isset($_GET['latest'])){echo 'active';} ?>" href="?latest=true">Latest Questions</a>
        </li>
      </ul>
